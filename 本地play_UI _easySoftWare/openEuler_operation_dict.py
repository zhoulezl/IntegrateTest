...
# 消息中心
def enter_messag_center(page: sync_api.Page):
    """ 进入消息中心 """
    page.hover('.user-img')
...
def click_repo_source(page: sync_api.Page):
    ...
    page1 = page_info.value
    expect(page1.get_by_role("heading", name="Index of /")).to_be_visible()
    page1.close()
    return page
...
def click_openeuler_best_courses(page: sync_api.Page):
    ...
    expect(page1.get_by_text("基础软件服务能力平台")).to_be_visible()
    page1.close()
    return page
...
def enter_oepkgs(page: sync_api.Page):
    ...
    page1 = page_info.value
    expect(page1.get_by_role("img", name="logo-176-60")).to_be_visible()
...
def assert_blog_data(page: sync_api.Page):
    """ 断言博客数据"""
...
def assert_news_data(page: sync_api.Page):
    """ 断言新闻数据 """
...
def friend(page: sync_api.Page):
    ...
    expect(page5.get_by_text("登录/注册")).to_be_visible()
    page5.close()
...
def_dict = {
    ...
    "首页断言博客数据": assert_blog_data,
    "首页查看更多博客": home_more_blog,
    "首页断言新闻数据": assert_news_data,
